...
/*
	...
	Tri-licensed under CC BY-SA 3, MPL 2, and LGPL 3
*/
...
(function () {
	...
	if (f.search.textbox.value === "\\b[Rr]eg([Ee]xp?|ular expression)\\b") {
		f.search.textbox.onfocus = makeResetter(f.search);
	}
	if (f.input.textbox.value === "Don't ever write another regex / regular expression / RegExp blindly") {
